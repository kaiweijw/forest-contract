...
public partial class ForestContractTests_MakeOffer
{
    ...
    [Fact]
    public async void BatchBuyNow_Buy_From_OneUser_Two_Listing_Record_Success()
    {
        ...
        #region BatchBuyNow user2 buy from user1 two listing record
