...
public partial class ForestContractTests
{
    ...
    public async Task DealToFixedPriceBuyerInWhiteList()
    {
        ...
        });
        {
            ...
            var whitelistIds =
                await WhitelistContractStub.GetWhitelistByManager.CallAsync(ForestContractAddress);
...

        {
            ...
            balance.Balance.ShouldBe(DefaultSenderInitialELFAmount + 10_00000000 - 10_00000000 / 1000);
        }
    ...
    public async Task DealToFixedPriceBuyerInWhiteList_Complicated()
    {
        ...
        var whitelistId = (await SellerForestContractStub.GetWhitelistId.CallAsync(new GetWhitelistIdInput()
        {
            Symbol = symbol,
            TokenId = 233,
            Owner = DefaultAddress
    ...
    {
        var symbol = await Initialize();
        var executionResult1 = await SellerForestContractStub.ListWithFixedPrice.SendAsync(
        ...
        var executionResult2 = await SellerForestContractStub.ListWithFixedPrice.SendAsync(
            new ListWithFixedPriceInput
            {
                Symbol = symbol,
                TokenId = 233,
    ...
    public async Task ListWithFixedPriceWhitelist_NoWhitelistContract()
    {
        ...
        var executionResult1 = await SellerForestContractStub.ListWithFixedPrice.SendWithExceptionAsync(
            new ListWithFixedPriceInput
            {
                Symbol = symbol,
                TokenId = 233,
    ...
    public async Task MakeOfferTest_WithWhitelist_ToOfferList()
    {
        ...
        var executionResult2 = await Buyer2ForestContractStub.MakeOffer.SendAsync(new MakeOfferInput
        {
            Symbol = symbol,
            TokenId = 233,
            OfferTo = DefaultAddress,
        ...
        {
            var offerList = await Buyer2ForestContractStub.GetOfferList.CallAsync(new GetOfferListInput
            {
                Symbol = symbol,
                TokenId = 233,
                Address = User3Address
    ...
    {
        {
            ...
            await SellerForestContractStub.ListWithFixedPrice.SendAsync(
                new ListWithFixedPriceInput
                {
                    Symbol = symbol,
                    TokenId = 233,
    ...
    public async Task MakeOfferTest_WithPublicTime()
    {
        ...
        {
            var offerTo = OfferAdded.Parser.ParseFrom(executionResult2.TransactionResult.Logs
                .First(l => l.Name == nameof(OfferAdded)).NonIndexed).OfferTo;
            offerTo.ShouldBe(DefaultAddress);
        }
    }
    ...
    {
        await BuyerForestContractStub.Initialize.SendAsync(new InitializeInput
        {
            NftContractAddress = NFTContractAddress,
            ServiceFeeReceiver = MarketServiceFeeReceiverAddress
        });
        await BuyerForestContractStub.SetWhitelistContract.SendAsync(WhitelistContractAddress);
        ...
        await BuyerForestContractStub.MintBadge.SendAsync(new MintBadgeInput()
        {
            Symbol = symbol,
            TokenId = 1
        });
        var exception = await Buyer2ForestContractStub.MintBadge.SendWithExceptionAsync(new MintBadgeInput()
        {
            Symbol = symbol,
            TokenId = 1
        });
    ...
    public async Task<string> CreateBadgeTest_new_whitelistIdNull()
    {
        ...
        var executionResult1 = await BuyerForestContractStub.MintBadge.SendWithExceptionAsync(new MintBadgeInput()
        {
            Symbol = symbol,
            TokenId = 1
        });
    ...
    [Fact]
    public async Task MakeOfferTest_WithWhitelistZero()
    {
        await AdminForestContractStub.Initialize.SendAsync(new InitializeInput
        {
            NftContractAddress = NFTContractAddress,
        ...
        }
        {
            ...
            balance.Balance.ShouldBe(InitialELFAmount - 0_00000000);
        }
    }

    [Fact]
    public async Task MakeOffer_WhitelistToOfferList()
    {
        var symbol = await Initialize();
        ...
        });
        {
            ...
            nftBalance.Balance.ShouldBe(12);
        }
        {
            var balance = await TokenContractStub.GetBalance.CallAsync(new AElf.Contracts.MultiToken.GetBalanceInput
            {
            ...
            balance.Balance.ShouldBe(InitialELFAmount - 90_00000000 - 100_00000000 * 4 - 200_00000000 * 7);
        }
        {
            var offerList = await BuyerForestContractStub.GetOfferList.CallAsync(new GetOfferListInput
            {
            ...
            offerList.Value.Count.ShouldBe(1);
            offerList.Value[0].Quantity.ShouldBe(1);
            offerList.Value[0].Price.Amount.ShouldBe(200_00000000);
        }
    }
}